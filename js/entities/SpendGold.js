game.SpendGold = Object.extend({
    ...
    startBuying: function(){
        ...
        game.data.buyscreen = new me.Sprite(game.data.pausePos.y, me.loader.getImage('gold-screen'));
    ...
    setBuyText: function(){
       game.data.buytext = new (me.Renderable.extend({
                   ...
                   draw: function(renderer){
                        this.font.draw(renderer.getContext(), "PRESS F1-F5 TO BUY, B TO SKIP. Current Gold: " + game.data.gold, this.pos.x, this.pos.y);
